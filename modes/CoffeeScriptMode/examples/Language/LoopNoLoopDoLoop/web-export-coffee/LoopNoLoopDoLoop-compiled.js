var SketchLoopnoloopdoloop;

SketchLoopnoloopdoloop = (function() {
  ...
  SketchLoopnoloopdoloop.name = 'SketchLoopnoloopdoloop';

  function SketchLoopnoloopdoloop() {}
  ...
  */
  ...
  SketchLoopnoloopdoloop.prototype.setup = function() {
  ...
  SketchLoopnoloopdoloop.prototype.draw = function() {
    var x, y, _ref, _results;
    background(frameCount % 255);
    _ref = [20, 20], x = _ref[0], y = _ref[1];
    _results = [];
    while (true) {
      fill(x);
      rect(x, y, 20, 20);
  ...
  SketchLoopnoloopdoloop.prototype.keyPressed = function() {
    return doLoop();
  };

  return SketchLoopnoloopdoloop;
