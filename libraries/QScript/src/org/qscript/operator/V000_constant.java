...
/**
 * V000 constant ( vector position [0,0,0] )
 * 
 * @author Peter Lager
 *
 */
public class V000_constant extends Operator {

	public V000_constant(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		return new Argument(Vector.ZERO_VECTOR);
	}
