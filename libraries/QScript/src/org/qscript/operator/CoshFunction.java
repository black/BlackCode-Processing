 ...
 *
 */
public class CoshFunction extends Operator {

	public CoshFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.cosh(a0.toDouble()));
		if(a0.isComplex)
			return new Argument(Complex.cosh(((Complex)a0.getValue())));
