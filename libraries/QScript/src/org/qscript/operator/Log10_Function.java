...
/**
 * log<sub>10</sub>(n) logarithm to base 10 function
 * 
 * @author Peter Lager
 *
 */
public class Log10_Function extends Operator {

	public Log10_Function(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.log10(a0.toDouble()));
