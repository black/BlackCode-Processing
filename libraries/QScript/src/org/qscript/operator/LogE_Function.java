...
/**
 * log<sub>e</sub>(n) natural logarithm
 * 
 * @author Peter Lager
 *
 */
public class LogE_Function extends Operator {

	public LogE_Function(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.log(a0.toDouble()));
		if(a0.isComplex)
			return new Argument(Complex.log((Complex)a0.getValue()));
