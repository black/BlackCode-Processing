...
/**
 * e<sup>n</sup> exponential function
 * 
 * @author Peter Lager
 *
 */
public class ExpFunction extends Operator {

	public ExpFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		Argument a0 = args[0];
		if(a0.isNumeric)
			return new Argument(Math.exp(a0.toDouble()));
		if(a0.isComplex)
			return new Argument(Complex.exp((Complex)a0.getValue()));
