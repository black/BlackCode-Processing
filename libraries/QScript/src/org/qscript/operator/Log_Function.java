...
public class Log_Function extends Operator {

	public Log_Function(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		if(a0.isNumeric && a1.isNumeric){
			return  new Argument(Math.log(a0.toDouble()) / Math.log(a1.toDouble()) );
		}
