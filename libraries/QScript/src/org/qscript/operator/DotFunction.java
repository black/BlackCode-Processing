...
public class DotFunction extends Operator {

	public DotFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args,
		...
		if(a0.isVector && a1.isVector)
			return new Argument(new Double(Vector.dot((Vector)a0.getValue(), (Vector)a1.getValue())));
