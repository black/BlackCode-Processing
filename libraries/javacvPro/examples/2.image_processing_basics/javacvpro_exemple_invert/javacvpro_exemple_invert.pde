...
void setup(){ // fonction d'initialisation exécutée 1 fois au démarrage
	...
	opencv = new OpenCV(this); // initialise objet OpenCV à partir du parent This
        ...
        opencv.invert(); // inverse le buffer principal OpenCV
        //opencv.invert(opencv.Buffer); // inverse le buffer OpenCV désigné
        //opencv.invert(opencv.BUFFER); // inverse le buffer OpenCV désigné
        //opencv.invert("BUFFER"); // inverse le buffer OpenCV désigné
