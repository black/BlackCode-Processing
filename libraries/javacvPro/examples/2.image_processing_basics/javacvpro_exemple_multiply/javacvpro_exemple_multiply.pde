...
void setup(){ // fonction d'initialisation exécutée 1 fois au démarrage
	...
	opencv = new OpenCV(this); // initialise objet OpenCV à partir du parent This
        ...
        //opencv.multiply(3.5); // multiplie tous les pixels par une valeur 
        opencv.multiply(0.5,1.0,2.0); // multiplie tous les pixels avec une valeur différente par canal
