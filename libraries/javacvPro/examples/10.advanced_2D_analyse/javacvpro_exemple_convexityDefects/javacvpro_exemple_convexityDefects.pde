...
// Exemple fonction convexityDefects() et drawConvexityDefects() 
...
void setup(){ // fonction d'initialisation exécutée 1 fois au démarrage
	...
	opencv = new OpenCV(this); // initialise objet OpenCV à partir du parent This
       ...
       for (int i=0; i<blobsArray.length; i++) { // passe en revue les blobs
          ...
          opencv.drawConvexityDefects(cdArray); 
          //opencv.drawConvexityDefects(cdArray, opencv.width(),opencv.height(),1.0); 
