...
/**
 * Get the time since this script started evaluation
 * 
 * @author Peter Lager
 *
 */
public class RuntimeFunction extends Operator {

	public RuntimeFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		return new Argument(new Double(script.getRunTime()));
	}
}
