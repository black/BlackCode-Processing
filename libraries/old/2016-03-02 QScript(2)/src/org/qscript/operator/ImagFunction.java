 ...
 *
 */
public class ImagFunction extends Operator {

	public ImagFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object... objects) throws EvaluationException {
		...
		Argument a0 = args[0];
		if(a0.isComplex)
			return new Argument(new Double(((Complex)a0.getValue()).imag));
