 ...
 *
 */
public class ConjugateFunction extends Operator {

	public ConjugateFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args,
		...
		Argument a0 = args[0];
		if(a0.isComplex)
			return new Argument(Complex.conj((Complex)a0.getValue()));
