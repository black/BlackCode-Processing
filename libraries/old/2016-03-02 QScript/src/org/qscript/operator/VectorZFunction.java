...
/**
 * Get the z value from a vector
 * 
 * @author Peter Lager
 *
 */
public class VectorZFunction extends Operator {

	public VectorZFunction(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args,
		...
		Argument a0 = args[0];
		if(a0.isVector)
			return new Argument(new Double( ((Vector)a0.getValue()).z));
