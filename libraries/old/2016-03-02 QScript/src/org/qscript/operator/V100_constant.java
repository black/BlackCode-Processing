...
/**
 * V100 constant ( vector position [1,0,0] )
 * 
 * @author Peter Lager
 *
 */
public class V100_constant extends Operator {

	public V100_constant(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		return new Argument(Vector.X_VECTOR);
	}
