...
/**
 * V010 constant ( vector position [0,1,0] )
 * 
 * @author Peter Lager
 *
 */
public class V010_constant extends Operator {

	public V010_constant(String symbol, int nbrArgs, int priority, int type) {
	...
	public Argument resolve(Script script, Token token, Argument[] args, Object...objects) 
		...
		return new Argument(Vector.Y_VECTOR);
	}
