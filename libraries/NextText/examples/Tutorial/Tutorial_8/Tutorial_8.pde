...
void setup() {
  ...
  // create the reform Behaviour
  Reform reform = new Reform();
  
  // combine the follow mouse and reform Behaviours in a Multiplexer
  Multiplexer followAndReform = new Multiplexer();
  followAndReform.add(followMouseAlways);
  ...
  OnMouseOverApplet followOrPullBack = new OnMouseOverApplet(this, followAndReform, pullBack);
